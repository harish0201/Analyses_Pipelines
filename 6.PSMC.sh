...
~/psmc/samtools mpileup -C50 -uf ../../primary.fasta -r ScaffHiC_101\|arrow\|pilon GIB-10.sorted.bam | ~/psmc/bcftools view -c /dev/stdin  | ~/psmc/vcfutils.pl vcf2fq -d 5 -D 34 -Q 30 > 3.ScaffHiC_101\|arrow\|pilon.fq
...
~/psmc/utils/fq2psmcfa -q20 3.ScaffHiC_101\|arrow\|pilon.fq > 3.ScaffHiC_101\|arrow\|pilon.fa
...
psmc_plot.pl -u 4e-09 -g 5  GIB3.combined.plot GIB3.combined.psmc  
